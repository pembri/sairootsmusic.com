// Data Schema Universal untuk SAI Roots (Versi Anti-Bentrok + Wikidata Optimized)
(function() {
  const schemaData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "url": "https://sairootsmusic.com/",
        "image": [
          "https://sairootsmusic.com/asset_gambar/sairoots.jpg",
          "https://upload.wikimedia.org/wikipedia/commons/0/03/SAI_Roots.jpg"  // Wikimedia version
        ],
        "genre": ["Reggae", "Rap", "Ska", "Roots Reggae", "Indonesian Reggae"],
        "countryOfOrigin": {
          "@type": "Country",
          "name": "Indonesia"
        },
      ...
      },
      {
        ...
        "url": "https://sairootsmusic.com/",
        "image": "https://commons.wikimedia.org/wiki/File:Ahmad_Supembri.jpg", // jika ada
        "sameAs": [
      ...
      },
      {
        ...
        "sameAs": [
          "https://www.wikidata.org/wiki/Q139784313"
        ]
      }
    ]
  };

  // Suntik JSON-LD ke halaman
